...
def main():
    ...
    # ===== EXCITATION =====
    print("\n--- Excitation ---")
    # DNA_Opt2 uses Born excitation (NOT Emfietzoglou).
    # G4EmDNABuilder: opt=2 → G4DNABornExcitationModel → sigma_excitation_e_born
    ...
    output.append(f"// Excitation: Born model (DNA_Opt2)")
